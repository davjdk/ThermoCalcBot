...
📝 *Примеры запросов:*
`1. Термодинамические свойства хлорида хрома с шагом 50 Кельвин`
`2. Reaction: 3Fe2O3 + CO = 2Fe3O4 + CO2; Coumpounds: [Iron(III) oxide, Carbon monoxide, Iron(II,III) oxide, Carbon dioxide]`
`3. Восстановление титана из фторида магнийтермией`

💡 *Используйте /help для подробной справки*
💡 *Для большей точности диапазон расчета должен включать 298 Кельвин*

ThermoSystem v2.2 - Термодинамическая система с LLM-интеграцией
        """.strip()
