...
📝 *Примеры запросов:*
`Термодинамические свойства хлорида хрома с шагом 50 Кельвин`
`Reaction: 3Fe2O3 + CO = 2Fe3O4 + CO2; Coumpounds: [Iron(III) oxide, Carbon monoxide, Iron(II,III) oxide, Carbon dioxide]`
`Восстановление титана из фторида магнийтермией`
