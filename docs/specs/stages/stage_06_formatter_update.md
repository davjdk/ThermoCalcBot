...
## Критерии завершения
- [x] Форматтер выводит все использованные сегменты с нумерацией
- [x] Для H₂₉₈=0 выводится "(накопленное)"
- [x] Фазовые переходы отображаются между сегментами с ΔH и ΔS
- [x] Колонка "Комментарий" содержит только фазовые переходы
- [x] Информация о спонтанности удалена из колонки "Комментарий"
- [x] Cp коэффициенты форматируются как массив
- [x] Метаданные (количество сегментов, переходов) выводятся в конце
- [x] Unit-тесты для форматирования всех типов вывода
- [x] Обратная совместимость: старый формат работает для одиночных записей
